...
import { SafeAreaView, Text, ScrollView, Image, View, StyleSheet, Dimensions, Switch, TouchableHighlight } from "react-native";
...
export const AddNewPostDetailsScreen = ({ navigation, route }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", position: "absolute", bottom: 0, left: 0, right: 0 , padding:20}}>
